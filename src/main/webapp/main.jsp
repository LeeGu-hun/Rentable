	...
	<div id="wrap">
		...
		<div id="rent_head">	
				<div style=" float: left; width: 15%;height: 100px;">
					<a href="${pageContext.request.contextPath}" style="width: 100%;height: 100%;"> 
						<img alt="" src="${pageContext.request.contextPath}/resources/images/rentable.jpg" style="width: 100%;height: 100%;">
					</a>
				</div>
